...
alert("Let's check out some math!");

// 3. Create a variable and use the prompt() method to collect a number from a visitor
let answer_1 = prompt("Give me a number between 1 and 100");
...
//    "3 / 4 = 0.75"
//    "3 - 4 = -1"
message += number_1 + " * " + number_2 + " = " + (number_1 * number_2) + "<br>";
message += number_1 + " / " + number_2 + " = " + (number_1 / number_2) + "<br>";
message += number_1 + " - " + number_2 + " = " + (number_1 - number_2) + "<br>";
